...
P_0 = P_linear_estimate_with_RANSAC(points_3D_bad,points_2D); % initialize with a linear solution
P = P_non_linear_estimate(P_0,points_3D_bad,points_2D);
[W,R,T] = calc_W_R_T(P);
...
ylabel('Error')
title('Error Curve with Non-linear Method');
